...
urlpatterns = [
    ...
    path('cart/remove/<int:item_id>/', views.remove_from_cart, name='remove_cart_item'),  # Удален дублирующийся URL
    path('cart/update/<int:item_id>/', views.update_cart_item, name='update_cart_item'),  # Добавлен URL для обновления
    path('checkout/', views.checkout, name='checkout'),
    path('orders/', views.order_list, name='order_list'),
    path('logout/', LogoutView.as_view(next_page='index'), name='user_logout'),  # Используем LogoutView
